...
import (
	...
	"github.com/ayanmw/multi-agent-platform/internal/cost"
	...
	"github.com/ayanmw/multi-agent-platform/internal/version"
	...
	"github.com/ayanmw/multi-agent-platform/web"
...
func main() {
	...
	webSearchCfg := tool.WebSearchConfig{
		...
		EnableBaidu:         cfg.WebSearchEnableBaidu,
		EnableSogou:         cfg.WebSearchEnableSogou,
		EnableBingCnHTML:    cfg.WebSearchEnableBingCnHTML,
	...
	observability.DefaultLogger.Info("web_search", "tool wired", map[string]any{
		...
		"enable_baidu":        webSearchCfg.EnableBaidu,
		"enable_sogou":        webSearchCfg.EnableSogou,
		"enable_bing_cn_html": webSearchCfg.EnableBingCnHTML,
		"disable_ddg":         webSearchCfg.DisableDDG,
	})
