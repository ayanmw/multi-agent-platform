...
> **最近更新**: 2026-07-23
> **当前版本**: v0.12.1 Alpha（session 级 git worktree 隔离工作区，per-run 可变 CWD + worktree/* Agent Tools + 启动孤儿扫描兜底）
...
> **日期**: 2026-07-23  
> **版本**: v0.12.1 Alpha  
> **OpenSpec change**: `openspec/changes/add-workspace-worktree-isolation/`
