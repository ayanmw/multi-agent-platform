...
No existing v2-auto-approval requirement text is altered; this capability adds a new UI configuration surface and changes `v2-auto-approval` to read from that configuration instead of a hard-coded list.
